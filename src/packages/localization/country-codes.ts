export enum CountryCodeIso3166Alpha2 {
  Afghanistan = "AF",
  AlandIslands = "AX",
  Albania = "AL",
  Algeria = "DZ",
...
export const CountryCodesIso3166Alpha2AndAlpha3: {[countryName: string]: {alpha2: string, alpha3: string}} = {
  ...
  "Bonaire, Sint Eustatius and Saba": { alpha2: "BQ", alpha3: "BES" },
  ...
  "Korea (Democratic People's Republic of)": { alpha2: "KP", alpha3: "PRK" },
  ...
  "United Kingdom of Great Britain and Northern Ireland": { alpha2: "GB", alpha3: "GBR" },
