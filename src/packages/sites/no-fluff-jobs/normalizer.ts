...
import { contractTypeToNormalizedEmploymentTypeMap, currencyToNormalizedCurrencyMap, seniorityToNormalizedSeniorityMap } from "./normalizer-mapping";

export default function normalizer(jobOffer: NoFluffJobsJobOfferSimple, url: string): JobOfferSimple {
  return {
    id: jobOffer.id,
    url: url,
